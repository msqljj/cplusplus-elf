#ifndef _TIME_MSVC_HPP
#define _TIME_MSVC_HPP
#ifdef _WIN32
...
strptime_msvc(const char *buf, const char *fmt, struct tm *tm)
{
     ...
     */
        case 'c': /* Date and time, using the locale's format. */
            LEGAL_ALT(ALT_E);
            if (!(bp = strptime_msvc(bp, "%x %X", tm)))
                return (0);
            break;

        case 'D': /* The date as "%m/%d/%y". */
            LEGAL_ALT(0);
            if (!(bp = strptime_msvc(bp, "%m/%d/%y", tm)))
                return (0);
            break;

        case 'R': /* The time as "%H:%M". */
            LEGAL_ALT(0);
            if (!(bp = strptime_msvc(bp, "%H:%M", tm)))
                return (0);
            break;

        case 'r': /* The time in 12-hour clock representation. */
            LEGAL_ALT(0);
            if (!(bp = strptime_msvc(bp, "%I:%M:%S %p", tm)))
                return (0);
            break;

        case 'T': /* The time as "%H:%M:%S". */
            LEGAL_ALT(0);
            if (!(bp = strptime_msvc(bp, "%H:%M:%S", tm)))
                return (0);
            break;
